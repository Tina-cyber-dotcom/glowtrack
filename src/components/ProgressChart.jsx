...
export default function ProgressChart() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-[#FFF8E7]">
      {/* Scrollable Content */}
      <div className="flex-1 w-full p-4 max-w-3xl">
        {/* Header */}
        <h1
        ...
        {/* Chart */}
        <div className="mt-6 bg-white/60 backdrop-blur-md rounded-xl p-4 shadow-lg">
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
              ...
              <Tooltip />
              <Line type="monotone" dataKey="exercises" stroke={darkText} strokeWidth={3} dot={{ r: 6 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
